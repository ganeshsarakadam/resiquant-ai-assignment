import {createDocUrl}  from "./submissions.manifest"
import { Document } from "@/types"

interface DocumentMap {
    [key: string]: Document
}
export const document_map: DocumentMap = {
    "pdf-town-squire-owners-association": {
    ...
    "xlsx-sov-remmet-2": {
        name: "8010 Remmet Ave LLC - SOV - 2024.xls",
        id: "xlsx-sov-remmet-2",
        type: "xlsx",
        url: createDocUrl("sub_7", "8010 Remmet Ave LLC - SOV - 2024.xls")
    },
    "pdf-mail-remmet-2": {
        name: "Mail - Francisco Galvis - Outlook.pdf",
        id: "pdf-mail-remmet-2",
        type: "pdf",
        url: createDocUrl("sub_7", "Mail - Francisco Galvis - Outlook.pdf")
    },
    "xlsx-quake-sov": {
